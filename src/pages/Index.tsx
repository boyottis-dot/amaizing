...
import YouMightBeLookingFor from "@/components/YouMightBeLookingFor";
...
const Index = () => {
  ...
  return (
    <div className="max-w-md mx-auto min-h-screen bg-background px-4 pb-28">
      ...
      <div className="mt-6" onClick={() => setSelectedPost(featuredPosts[1])}>
        <div className="cursor-pointer">
          <FeaturedPostCard
            vendorName="Jessica M."
            vendorHandle="@jess.reviews"
      ...
      <div className="mt-6" onClick={() => setSelectedPost(featuredPosts[2])}>
        <div className="cursor-pointer">
          <FeaturedPostCard
            vendorName="David K."
            vendorHandle="@david.foodie"
      ...
      <div className="mt-6" onClick={() => setSelectedPost(featuredPosts[3])}>
        <div className="cursor-pointer">
          <FeaturedPostCard
            vendorName="Kofi Mensah"
            vendorHandle="@kofi.craft"
