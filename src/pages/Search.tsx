...
import fashionCollectionImage from "@/assets/shop-collection-fashion.jpg";
import craftsCollectionImage from "@/assets/shop-collection-crafts.jpg";
import homeCollectionImage from "@/assets/shop-collection-home.jpg";
import beautyCollectionImage from "@/assets/shop-collection-beauty.jpg";
...
const trendingProducts = [
  { id: 11, name: "Canvas Sneakers", price: "$78", image: "https://picsum.photos/seed/trend1/400/400" },
  { id: 12, name: "Silver Ring", price: "$55", image: "https://picsum.photos/seed/trend2/400/400" },
  { id: 13, name: "Macramé Wall Art", price: "$62", image: "https://picsum.photos/seed/trend3/400/400" },
  { id: 14, name: "Clay Earrings", price: "$24", image: "https://picsum.photos/seed/trend4/400/400" },
] as const;

const products = [
  { id: 1, name: "Silk Scarf", price: "$42", image: "https://picsum.photos/seed/prod1/400/400" },
  { id: 2, name: "Handmade Earrings", price: "$28", image: "https://picsum.photos/seed/near1/400/400" },
  { id: 3, name: "Leather Wallet", price: "$65", image: "https://picsum.photos/seed/p3/400/400" },
  { id: 4, name: "Gold Necklace", price: "$120", image: "https://picsum.photos/seed/p2/400/400" },
  { id: 5, name: "Ceramic Mug", price: "$32", image: "https://picsum.photos/seed/near3/400/400" },
  { id: 6, name: "Woven Basket", price: "$45", image: "https://picsum.photos/seed/near4/400/400" },
] as const;

const relatedProducts = [
  { id: 7, name: "Art Print", price: "$28", image: "https://picsum.photos/seed/p7/400/400" },
  { id: 8, name: "Beaded Bracelet", price: "$18", image: "https://picsum.photos/seed/p8/400/400" },
  { id: 9, name: "Linen Tote", price: "$38", image: "https://picsum.photos/seed/p9/400/400" },
  { id: 10, name: "Scented Candle", price: "$22", image: "https://picsum.photos/seed/p10/400/400" },
] as const;
...
const ProductCard = ({ item }: { item: ProductItem }) => (
  <div className="aspect-square rounded-[20px] overflow-hidden relative shrink-0 w-[175px] snap-start cursor-pointer active:scale-[0.97] transition-transform">
    ...
    <button
      ...
      className="absolute top-3 right-3 w-9 h-9 rounded-full bg-[hsl(var(--background)/0.15)] backdrop-blur-xl flex items-center justify-center border border-[hsl(var(--background)/0.15)]"
    >
...
const ProductCarousel = ({
  ...
  <section className="pt-6">
    ...
    <div
      className="flex gap-3 overflow-x-auto no-scrollbar px-4 pb-1 snap-x snap-mandatory scroll-pl-4 overscroll-x-contain"
  ...
  <section className="pt-4 px-4">
    <div className="relative rounded-[24px] overflow-hidden min-h-[220px]">
      ...
      <div className="relative flex min-h-[220px] flex-col justify-end p-5">
        ...
        <h2 className="mt-3 text-2xl font-bold tracking-[-0.03em] text-[hsl(var(--background))]">
          New Market Edit
        </h2>
        <p className="mt-1.5 max-w-[15rem] text-[13px] leading-5 text-[hsl(var(--background)/0.78)]">
          Fresh fashion, modern home pieces, and crafted details in one curated drop.
        </p>
...
const Search = () => {
  ...
  return (
    <div className="min-h-screen bg-background max-w-md mx-auto relative">
      ...
      <div className="pb-28">
        <FeaturedBanner />
        <ProductCarousel title="Trending Right Now" items={trendingProducts} />
        <VendorRow />
        <ProductCarousel title="Continue Browsing" items={products} />
        <div className="px-4">
          <StackedCards />
        </div>
        <ProductCarousel title="Fresh Finds" items={relatedProducts} />
        <div className="px-4">
          <StackedCards />
        </div>
      </div>
